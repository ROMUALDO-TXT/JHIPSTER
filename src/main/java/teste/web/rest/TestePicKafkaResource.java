...
import teste.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/teste-pic-kafka")
public class TestePicKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TestePicKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public TestePicKafkaResource(KafkaProperties kafkaProperties) {
